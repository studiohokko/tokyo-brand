...
<section class="p-item">
   <div class="p-item__textArea">
      ...
      <p class="p-item__en<?php echo $en_modifier ? ' ' . esc_attr($en_modifier) : ''; ?>"><?php echo esc_html($en); ?>
      </p>
   </div>
   <!-- /.p-item__textArea -->
   <div class="p-item__imageArea">
      <figure class="p-item__image">
         <picture>
            ...
            <img src="<?php echo esc_url(get_theme_file_uri('dev/public/assets/img/sp/p-item_' . $image . '.webp')); ?>"
