...
<main class="l-main">
   <section class="p-thanks">
      <div class="p-thanks__inner l-inner">
         <p class="p-thanks__title">お問合せが<br class="u-only__sp">完了いたしました</p>
         <div class="p-thanks__content">
            ...
            <div class="p-thanks__telBox">
               <a href="" class="p-thanks__tel u-pointerNone__sp">
                  <p class="p-thanks__telText">お電話でのお問合せ</p>
                  <p class="p-thanks__telNumber">03-5990-4745</p>
                  <p class="p-thanks__telTime">受付時間12:30-21:00</p>
               </a>
            </div>
            <!-- /.p-thanks__telBox -->
            <div class="p-thanks__buttonWrapper">
               <a href="" class="p-thanks__button">Topページへ戻る</a>
            </div>
